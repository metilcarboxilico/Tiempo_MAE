        ...
        float snoise(vec2 v){
            ...
            vec3 p=permute(
                ...
                void main(){
                    ...
                    //if(scl != 0.0 ||scl != 1.0) uvMod = scale(uvMod,scl);
                    ...
                    sumaFormas=mix(sumaFormas,sumModfbm,.572);
                    
                    //-----------------------------------------------------
                    
                    float mezclaElipse=1.;
                    ...
                    sumaFormas=step(.076,sumaFormas);
                    ...
                    vec4 fin=vec4(vec3(sumaFormas),1.);
